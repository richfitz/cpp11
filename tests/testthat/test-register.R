...
test_that("registration of package with both cpp11::register and .C is possible", {
  pkg <- local_package()
  p <- pkg_path(pkg)
  dir.create(file.path(p, "src"))
  dir.create(file.path(p, "R"))
  brio::write_lines(
    path = file.path(p, "src/code_c.c"),
    c("#include <R.h>",
      "void do_add_c(double * a, double * b, double * res) {",
      "  *res = *a + *b;",
      "}"))
  brio::write_lines(
    path = file.path(p, "src/code_cpp.cpp"),
    c("#include <cpp11.hpp>",
      "[[cpp11::register]]",
      ...
      "}"))
  brio::write_lines(
    path = file.path(p, "R/code.R"),
    c("add_c <- function(a, b) {",
      "  .C(`do_add_c`, a, b, numeric(1))[[3]]",
      "}"))
  cpp_register(p)
...
// code_cpp.cpp
double add_cpp(double a, double b);
extern \"C\" SEXP _testPkg_add_cpp(SEXP a, SEXP b) {
  BEGIN_CPP11
    return cpp11::as_sexp(add_cpp(cpp11::as_cpp<cpp11::decay_t<double>>(a), cpp11::as_cpp<cpp11::decay_t<double>>(b)));
  END_CPP11
}

extern \"C\" {
/* .C calls */
extern void do_add_c(void *, void *, void *);


static const R_CMethodDef CEntries[] = {
    {\"do_add_c\", (DL_FUNC) &do_add_c, 3},
    {NULL, NULL, 0}
};
static const R_CallMethodDef CallEntries[] = {
    {\"_testPkg_add_cpp\", (DL_FUNC) &_testPkg_add_cpp, 2},
    {NULL, NULL, 0}
};
}
...
test_that("registration of package with cpp11::register, .Call and .C is possible", {
  pkg <- local_package()
  p <- pkg_path(pkg)
  dir.create(file.path(p, "src"))
  dir.create(file.path(p, "R"))
  brio::write_lines(
    ...
    c("#include <R.h>",
      ...
      "SEXP do_add_call(SEXP a, SEXP b) {",
  ...
  brio::write_lines(
    path = file.path(p, "R/code.R"),
    c("add_call <- function(a, b) {",
      "  .Call(`do_add_call`, a, b)",
      "}",
      "add_c <- function(a, b) {",
      "  .C(`do_add_c`, a, b, numeric(1))[[3]]",
      "}"))
...
/* .Call calls */
extern SEXP do_add_call(SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {\"_testPkg_add_cpp\", (DL_FUNC) &_testPkg_add_cpp, 2},
    {\"do_add_call\",      (DL_FUNC) &do_add_call,      2},
    {NULL, NULL, 0}
};
}
